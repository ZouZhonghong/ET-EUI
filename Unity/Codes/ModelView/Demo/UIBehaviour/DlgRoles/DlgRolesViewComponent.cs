...
namespace ET
{
	...
	public  class DlgRolesViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Text ELabel_StartText
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_ELabel_StartText == null )
     			{
		    		this.m_ELabel_StartText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EButton_Start/ELabel_Start");
     			}
     			return this.m_ELabel_StartText;
     		}
     	}
		...
		private UnityEngine.UI.Text m_ELabel_StartText = null;
